        ...
        foreach ($topicsLabelList as $label) {
        	...
        	for ($i = 1; $i <= 30 ; $i++) {
        		foreach ($reponseLabelList as $repLabel) {
        			...
        			$reponse->setContent("Question $label $i : Reponse $repLabel");
        			if ($repLabel === 'A') {
